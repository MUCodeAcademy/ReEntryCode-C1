...
Responsive web design allows for a page to be a pleasant experience regardless of what device is being used. We'll cover a lot of topics that are important but there are SO many more that you can learn.

## The Basics -

### Setting the viewport

Most development environments do this automatically with the prebuilt HTML code, but some older sites might not have it in already. It can be done with the following:
