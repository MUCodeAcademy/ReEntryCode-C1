...
- You should have only one css file that you reuse on all three pages with no styling in the head.
...
- Try to get started with just the instructions below, but if you get stuck, feel free to see the mock-ups included in this folder. Bear in mind that the images shown are ONLY shown as they would appear at a large resolution. Ensure that they are mobile friendly in their design using the patterns / tools we have learned thus far.
