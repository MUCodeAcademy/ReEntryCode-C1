...
describe("ExampleComponent", () => {
    it("should display the correct property", () => {
      // Gets the getByTestID function from the render function
      const { getByTestID } = render(<ExampleComponent />);
      // Gets the element with the test-id "prop-display"
      const prop1Value = getByTestId("prop-display");
      // It should have "Value Expected" as text content. If it does, the test passes. If not, it fails.
