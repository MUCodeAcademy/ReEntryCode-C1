...
describe('Confirmation', () => {
    ...
    it('should display button clicked text', async () => {
        ...
        // Get the button element with the text 'Test'
    ...
    it('should run the test function with the username', () => {
        // Creating a mocked version of our test function
        ...
        expect(mockedFn).toHaveBeenCalledWith('Luce'); // Check if it's been call with an argument
        expect(mockedFn).toHaveBeenCalledTimes(1); // Check how many times it's run
    });
});